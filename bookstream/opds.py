...
#Copyright(c)2009 Archive Stream. Software license GPL version 3.
...
if PORT not in [80, 443]:
    SERVICE_URL += ':%s' % PORT
ARCHIVE_DOMAIN = 'archivestream.github.io'
...
pubInfo = {
    ...
    'urnroot'    : 'urn:x-internet-archive:bookstream',
    'es_base'    : ES_URL,
...
def getDevice():
    ...
    return bookstream.device.Detect.createFromUserAgent(userAgent) if userAgent else None
...
class Index:
    def GET(self, url):
        ...
        c = IACatalog(
            title='Archive Stream Catalog',
            urn=pubInfo['urnroot'],
            url=pubInfo['opdsroot'] + '/',
            datestr=datestr,
            author='Archive Stream',
        ...
        e = catalog.Entry({'title': 'Most Downloaded Books',
                           ...
                           'updated': datestr,
                           'content': 'The most downloaded books from the Archive Stream in the last month.'
                         }, links=(l,))
        c.addEntry(e)
        ...
        e = catalog.Entry({'title': 'Recent Scans',
                           ...
                           'updated': datestr,
                           'content': 'Books most recently scanned by the Archive Stream.'
                         }, links=(l,))
        c.addEntry(e)
        ...
        e = catalog.Entry({'title': 'In Library',
                           ...
                           'updated': datestr,
                           'content': 'Archive Stream core lending collection.'
                         }, links=(l,))
        c.addEntry(e)
...
class AlphaList:
    ...
    def GET(self, extension):
        ...
        c = IACatalog(title     = 'Archive Stream - All Titles',
                      urn       = pubInfo['urnroot'] + ':titles:all',
...
class Simple:
    def GET(self, extension):
        ...
        main = IACatalog(title='Archive Stream OPDS Simple Feed', urn=urn, url=url)
...
class Borrow:
    def GET(self, ocaid):
        ...
        if not auth:
            ...
            # Use basic auth credentials to retrive archivestream.github.io s3 keys
            try:
                s3keys = ia.config.get_auth_config(email, password)
            except ia.exceptions.AuthenticationError:
                raise Loans.Unauthorized()

            # POST to archivestream.github.io with s3 keys to get acsm url
            loans_url = "https://%s/services/loans/beta/loan/?action=media_url&identifier=%s&format=expub" % (ARCHIVE_DOMAIN, ocaid)
            ...
            entry = """<entry>
                    ...
                    <opds:indirectAcquisition type="application/expub+zip"/>
                    </link></entry>""" % acsm_url
...
class Htmlsearch:
    def GET(self, query):
        ...
        es_url = 'http://se.us.archivestream.github.io:8983/solr/select?q='+qq+'+AND+'+pubInfo['query_base']+'&fl=identifier,title,creator,oai_updatedate,date,contributor,publisher,subject,language,format&rows='+str(numRows)+'&page='+str(page)+'&wt=json'
        titleFragment = 'search results for ' + q
        urn = pubInfo['urnroot'] + ':search:%s:%d' % (qq, page)
...
class Authentication:
    ...
    "color_scheme": "black",
    "description": "archivestream.github.io Login",
    ...
    "authentication": [
     ...
     "links": [
         {"rel": "about", "href": "https://archivestream.github.io/about/", "type": "text/html"},
         {"rel": "alternate", "href": "https://archivestream.github.io", "type": "text/html"},
         {"rel": "help", "href": "mailto:info@archivestream.github.io"},
         {"rel": "logo", "href": "https://archivestream.github.io/logos/hires/ia-tight-480x480.jpg", "type": "image/jpeg"},
         {"rel": "privacy-policy", "href": "https://archivestream.github.io/about/terms.php", "type": "text/html"},
         {"rel": "register", "href": "https://archivestream.github.io/account/login.createaccount.php", "type": "text/html"},
         {"rel": "start", "href": "https://archivestream.github.io/bookstream/catalog/simple", "type": "application/atom+xml;profile=opds-catalog;kind=acquisition"},
         {"rel": "support", "href": "mailto:info@archivestream.github.io"},
         {"rel": "http://librarysimplified.org/rel/designated-agent/copyright", "href": "mailto:info@archivestream.github.io"}
     ]
}""" % pubInfo['opdsroot']
...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/">
    <ShortName>Archive Stream Search</ShortName>
    <Description>Search archivestream.github.io's OPDS Catalog.</Description>
